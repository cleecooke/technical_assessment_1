...
var doubleStock = inStock * 2;          // ***COOKE-NOTE: created new variable to hold reassignment OR:
inStock = inStock * 2;
...
inStock--                               // ***COOKE-NOTE: should merely decrement the count by one

// Initialize a new variable "isFavorite", and assign it to a boolean value indicating
// if the food you chose is your favorite food or not

var isFavorite = "jajang";
if (food === isFavorite){
    return true;
}
...
function shouldOrderMore (crntStock) {
    if (crntStock < 20) {
        return true;
    } else {
        return false;
                                        ...
                                        // ***COOKE-NOTE
                                        /*      Working things out, think I'm over complifying things?
                                                var shouldOrderMore;
                                                function morePlease (shouldOrderMore, crntStock) {
                                                    if (crntStock < 20) {
                                                        return true;
                                                    } else {
                                                        return false;
...
function eatTime (a) {                  // ***COOKE-NOTE: assuming you call this function "eatTime(inStock)"
    if (a >= 1) {
...
function foodFav (a) {          // ***COOKE-NOTE: assuming you call this function "foodFav(inStock)"
    if (a === food){
...
var vegetables = ["broccoli", "carrot", "celery", "califlower", "sprout"]
...
var fruits = ["avacado", "banana", "cucumber", "peach", "pomegranet", "plum", "watermelon"]
